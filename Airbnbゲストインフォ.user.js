...
(function() {
    ...
    let guestName = document.getElementsByClassName("_26piifo")[0].innerText;
    ...
    let rescode = document.querySelectorAll(rescodeSelectorFromChropath)[0].innerText;
    let cico = document.querySelectorAll(dateSelectorFromChropath)[0].innerText.replace(/^(.*?)の予約[\s\S]+$/, "$1");
